...
export const ru: Translations = {
  ...
  seo: {
    ...
    description:
      "Githubster — бесплатный GitHub-инструмент с открытым исходным кодом. Сравнивайте публичные списки подписчиков и подписок, чтобы найти тех, кто не подписан в ответ, взаимные связи и данные профиля — без аккаунта Githubster.",
    feature1Title: "Не подписаны в ответ",
    ...
    feature3Desc: "Анализ профиля выполняется в браузере. Необязательный токен доступа не сохраняется.",
  },
  support: {
    nav: "Поддержать",
    title: "Поддержать Githubster",
    description: "Githubster бесплатный и с открытым исходным кодом. Если он вам полезен, вы можете поддержать его развитие.",
