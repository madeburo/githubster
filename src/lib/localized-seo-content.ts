...
const copy: Record<Exclude<Locale, "en">, CopyBySlug> = {
  ...
  sv: {
    "github-followers-checker": ["Kontroll av GitHub-följare", "Jämför offentliga listor över följare och följda konton. Githubster delar upp aktuella data i ömsesidiga kontakter, konton som inte följer tillbaka och följare som du ännu inte följer."],
    "github-not-following-back": ["Vem följer dig inte tillbaka på GitHub?", "Se vilka offentliga konton du följer som inte följer dig tillbaka just nu. Resultatet är en aktuell ögonblicksbild, inte historik över avföljningar."],
    "github-mutual-followers": ["Kontroll av ömsesidiga GitHub-följare", "Hitta konton som finns i båda offentliga listorna och upptäck utvecklare, bidragsgivare och kollegor som du har en ömsesidig kontakt med."],
    "github-profile-overview": ["Översikt över GitHub-profil", "Se offentliga repositories, stjärnor, viktigaste språk och följarrelationer. Ofullständiga data visas som otillgängliga, aldrig som missvisande nollor."],
    "github-followers-vs-following": ["GitHub-följare och följda konton: Vad är skillnaden?", "Följare följer en profil, medan följda konton är de konton som profilen följer. Konton i båda listorna är ömsesidiga kontakter."],
    "github-api-rate-limits-for-followers": ["GitHub API-gränser för följarlistor", "Stora listor kräver flera sidindelade API-anrop. En valfri token kan höja gränsen och stannar endast i den aktuella sessionen."],
  },
  no: {
    "github-followers-checker": ["Kontroll av GitHub-følgere", "Sammenlign offentlige lister over følgere og fulgte kontoer. Githubster deler gjeldende data inn i gjensidige forbindelser, kontoer som ikke følger tilbake, og følgere du ennå ikke følger."],
    "github-not-following-back": ["Hvem følger deg ikke tilbake på GitHub?", "Se hvilke offentlige kontoer du følger som ikke følger deg tilbake akkurat nå. Resultatet er et øyeblikksbilde, ikke historikk over avfølginger."],
    "github-mutual-followers": ["Kontroll av gjensidige GitHub-følgere", "Finn kontoer som finnes i begge de offentlige listene, og oppdag utviklere, bidragsytere og kolleger som du har en gjensidig forbindelse med."],
    "github-profile-overview": ["Oversikt over GitHub-profil", "Se offentlige repositories, stjerner, viktigste språk og følgerrelasjoner. Ufullstendige data vises som utilgjengelige, aldri som misvisende nuller."],
