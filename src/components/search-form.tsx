...
const onboarding: Record<Locale, string> = {
  ...
  cs: "Zadejte uživatelské jméno GitHub — data jsou veřejná a token je volitelný.",
  hu: "Adj meg egy GitHub-felhasználónevet — az adatok nyilvánosak, a token pedig opcionális.",
